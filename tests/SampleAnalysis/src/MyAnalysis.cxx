...
int main(int argc, char *argv[]) {
  ...
  a.AddCutAlgo(new HAL::PythonReconstructionAlgorithm("pyreco", "testing python algo", "/Users/jhetherly/src/root_HAL/tests/SampleAnalysis/include", "pyalgo", "PythonAlgo"));
