...
\subsubsection[{Import\+Counting\+Value}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Value\+Getter  = H\+A\+L\+::\+Analysis\+Tree\+Reader$>$ {\bf H\+A\+L\+::\+Algorithms\+::\+Import\+Counting\+Value}$<$ Value\+Getter $>$\+::{\bf Import\+Counting\+Value} (
