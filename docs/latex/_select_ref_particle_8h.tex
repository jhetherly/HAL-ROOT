...
\begin{DoxyCompactList}\small\item\em Generic algorithm class that selects particles with respect to a set of reference particles. \end{DoxyCompactList}\end{DoxyCompactItemize}
