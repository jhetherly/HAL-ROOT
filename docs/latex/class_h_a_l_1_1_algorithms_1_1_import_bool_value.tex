...
\subsubsection[{Import\+Bool\+Value}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Value\+Getter $>$ {\bf H\+A\+L\+::\+Algorithms\+::\+Import\+Bool\+Value}$<$ Value\+Getter $>$\+::{\bf Import\+Bool\+Value} (
