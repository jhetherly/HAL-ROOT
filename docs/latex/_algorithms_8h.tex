...
\begin{DoxyCompactList}\small\item\em Generic algorithm class that attaches a decimal value from a T\+Tree to an existing particle. \end{DoxyCompactList}\item 
