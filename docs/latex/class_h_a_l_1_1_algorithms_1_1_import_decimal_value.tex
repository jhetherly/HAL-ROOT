...
\subsubsection[{Import\+Decimal\+Value}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Value\+Getter $>$ {\bf H\+A\+L\+::\+Algorithms\+::\+Import\+Decimal\+Value}$<$ Value\+Getter $>$\+::{\bf Import\+Decimal\+Value} (
