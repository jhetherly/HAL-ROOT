...
\subsubsection[{Import\+Integer\+Value}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Value\+Getter $>$ {\bf H\+A\+L\+::\+Algorithms\+::\+Import\+Integer\+Value}$<$ Value\+Getter $>$\+::{\bf Import\+Integer\+Value} (
